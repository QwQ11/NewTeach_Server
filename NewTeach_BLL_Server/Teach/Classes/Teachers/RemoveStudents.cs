...
{
    internal class RemoveStudents
    {
        ClassInfo_mod cif;
        System.Net.Sockets.TcpClient client;
        int uid;

        internal RemoveStudents(DataPackage data, int user_id)
        {
        ...
        internal void Response()
        {
            ...
            {
                Client = client,
                Data = Re_Convert.ConvertToBytes_Op(sql.RemoveStudents(cif.Class_id, cif.Student_count, cif.Teacher_id), uid)
            });
        }
    }
}
